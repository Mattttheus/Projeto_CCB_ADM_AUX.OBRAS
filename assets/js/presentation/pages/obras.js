// Presentation/Pages — lista de obras (equivalente à listagem de page/gerenciar_obra.php).
// Inclui a designação de responsáveis pelo admin (obra_responsaveis): cada
// responsável de igreja passa a ver apenas as obras designadas a ele.
// O botão "Detalhes" navega para a página dedicada da obra (#obra?id=<id>),
// com cronograma, manutenção recorrente, financeiro, documentos e chamados.
...
function rows(ctx, items) {
    ...
    return items.length ? items.map(item => {
        ...
        <tr>
            ...
            <td>
                <button class="table-action" data-route-link="obra?id=${item.id}">Detalhes</button>
